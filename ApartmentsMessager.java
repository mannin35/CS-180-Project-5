...
public class ApartmentsMessager {
    ...
    public static void main(String[] args) {
        ...
        if (loggedIn) {
            System.out.println("You are now logged in as " + main.current.getUsername());
            //logged in as seller
            if (main.current.isSeller()) {
                ...
                while (mainMenu) {
                    ...
                    if (menuChoice.equals("Search for a buyer to message")) {
                        if (main.buyers.size() == 0) {
                            ...
                            while (main.recipient == null && !buyerSearch.equals("Quit")) {
                                ...
                                if (buyerSearch.equals("See list of buyers")) {
                                    String buyerList = "";
                                    //TODO is this how multiline string works?
                                    for (int i = 0; i < main.buyers.size() - 1; i++) {
                                        buyerList += main.buyers.get(i);
                                        buyerList += "\n";
                                    }
                                    buyerList += main.buyers.get(main.buyers.size() - 1);
                                    ServerProcessser.sendMessage(writer, buyerList, JOptionPane.INFORMATION_MESSAGE);
                                    do {
                                        String buyerChoice = ServerProcessser.sendInput(writer, reader,"Which buyer would you like to message?");
                                ...
                                } else if (buyerSearch.equals("Search for a buyer")) {
                                    System.out.println("Please enter the username of the buyer you would like to " +
                                            "message");
                                ...
                                } else if (buyerSearch.equals("Quit")) {
                                    break;
                                } else {
                            ...
                            if (!buyerSearch.equals("Quit")) {
                                ...
                                while (true) {
                                    ...
                                    if (messageMenuChoice.equals("View message history")) {
                                        for (Message m : main.currentConvo) {
                                            System.out.println(m.toString());
                                        }
                                        //send message
                                    } else if (messageMenuChoice.equals("Send a new message")) {
                                        String messageType = "";
                                        do {
                                            messageType = ServerProcessser.sendOptions(writer, reader,
                                                    "Would you like to:",
                                                    new String[] {"Send a message", "Send a file"});
                                            if (messageType.equals("Send a message")) {
                                                ...
                                                main.current.sendMessage(newMessage, main.currentConvo,
                                                        main.recipientConvo);
                                            } else if (messageType.equals("Send a file")) {
                                                String fileMessage = "";
                                        ...
                                        } while (!messageType.equals("Send a message") && !messageType.equals("Send a file"));
                                        System.out.println("Message sent successfully");
                                        //edit message
                                    } else if (messageMenuChoice.equals("Edit a message")) {
                                        if (main.currentConvo.size() == 0) {
                                            ...
                                            ServerProcessser.sendMessage(writer, messageHistory,
                                        ...
                                        //delete message
                                        //TODO stopping point 11/30 chloe
                                    } else if (messageMenuChoice.equals("Delete a message")) {
                                        if (main.currentConvo.size() == 0) {
                                    ...
                                    } else if (messageMenuChoice.equals("Export message history")) {
                                    ...
                                    } else if (messageMenuChoice.equals("Go back to the Main Menu")) {
                                        break;
                                    } else if (messageMenuChoice.equals("Quit")) {
                                        mainMenu = false;
                                        break;
                                    } else {
                                        System.out.println("Please choose a number from the menu to proceed.");
                        ...
                        //create store
                    } else if (menuChoice.equals("Create a store")) {
                        System.out.println("Please enter the name of the store you would like to create");
                        String store = input.nextLine();
                        accountManager.createStore(main.current.getUsername(), store);
                        System.out.println("Successfully created store!");
                        //block user
                    } else if (menuChoice.equals("Block a user")) {
                        if (main.buyers.size() == 0) {
                            System.out.println("There are currently no registered buyers for you to block.");
                        } else {
                    ...
                    } else if (menuChoice.equals("Become invisible to a user")) {
                        if (main.buyers.size() == 0) {
                            System.out.println("There are currently no registered buyers for you to become invisible " +
                                    "to.");
                        } else {
